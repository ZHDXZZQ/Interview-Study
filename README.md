...
| [**手撕基础库(更新中）**](./八股/手撕基础库.md)           | [**手撕设计模式(完）**](./八股/设计模式.md)       | [**分布式(待更新）**](./八股/分布式.md)                  |   
...
9. [**多数元素（同牛客剑指offer的 数组中出现次数超过一半的数字） - 简单**](https://leetcode.cn/problems/majority-element/description/?envType=study-plan-v2&envId=top-interview-150) -> [**题目详解**](./leetcode/多数元素.cpp)
...
37. [**两数之和（同牛客剑指offer的 和为S的两个数字） - 简单**](https://leetcode.cn/problems/two-sum/description/?envType=study-plan-v2&envId=top-interview-150) -> [**题目详解**](./leetcode/两数之和.cpp)
...
47. [**二叉树的最大深度（同牛客剑指offer的 二叉树的深度） - 简单**](https://leetcode.cn/problems/maximum-depth-of-binary-tree/description/?envType=study-plan-v2&envId=top-interview-150) -> [**题目详解**](./leetcode/二叉树的最大深度.cpp)
...
53. [**二叉树的层序遍历（类似牛客剑指offer的 从上往下打印二叉树） - 中等**](https://leetcode.cn/problems/binary-tree-level-order-traversal/description/?envType=study-plan-v2&envId=top-interview-150) -> [**题目详解**](./leetcode/二叉树的层序遍历.cpp)
...
417. [**扑克牌顺子 - 简单 - 剑指offer**](https://www.nowcoder.com/practice/762836f4d43d43ca9deb273b3de8e1f4?tpId=196&tqId=37092&rp=1&ru=/exam/oj&qru=/exam/oj&sourceUrl=%2Fexam%2Foj%3Fpage%3D1%26pageSize%3D50%26search%3D%25E5%25B7%25A6%25E6%2597%258B%25E8%25BD%25AC%25E5%25AD%2597%25E7%25AC%25A6%25E4%25B8%25B2%26tab%3D%25E7%25AE%2597%25E6%25B3%2595%25E9%259D%25A2%25E8%25AF%2595%26topicId%3D196&difficulty=undefined&judgeStatus=undefined&tags=&title=%E6%89%91%E5%85%8B%E7%89%8C%E9%A1%BA%E5%AD%90) -> [**题目详解**](./leetcode/扑克牌顺子.cpp)
...
- 曾任职于字节跳动抖音推荐架构开发    
- 曾收获字节、美团、百度、阿里、腾讯、小红书、vast、京东、快手、滴滴、Minimax、因诺、小马、360、虾皮、小米、得物、华为、大疆、元戎启行、经纬恒润等各大中小厂offer     
